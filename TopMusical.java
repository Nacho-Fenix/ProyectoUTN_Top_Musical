        ...
        public static void main(String[] args) {
                ...
                while (continuar) {
                        ...
                        do {
                                ...
                                if (top < 1 || top > 10) {
                                        System.out.println();
                                        System.out.println("¡El número del top no es válido!");
                        ...
                        System.out.println();
                        System.out.print("¿Deseas ingresar otro top? (s/n): ");
                ...
                System.out.println("!Gracias por su tiempo, esperamos le sea de ayuda esta informacion!");
        }
        ...
        private static void agregarTopsPredefinidos() {
                ...
                topBandas.put("TOTO",
                                new String[] { "Canción:Can you hear what im saying", "Canción:Love has the power",
                                                "Canción:Tale of a man", "Canción:The chains",
                                                "Canción:Dont chain my heart" });
                // top6
                topBandas.put("Green Day",
                                new String[] { "Canción:Basket Case", "Canción:American Idiot", "Canción:21 Guns",
                ...
                topBandas.put("Good Charlotte", new String[] { "Canción:I Just Wanna Live", "Canción:We Believe",
                                "Canción:The River", "Canción:The Chronicles of Life and Death",
                                "Canción:Last December" });
                // top8
                ...
                topBandas.put("Thirty Seconds To Mars",
                                new String[] { "Canción:Edge Of The Earth", "Canción:Capricorn (A Brand New Name)",
                                                "Canción:Oblivion",
